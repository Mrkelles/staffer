          ...
          <div className="md:flex md:items-center md:gap-12">
            <nav aria-label="Global" className="hidden md:block">
              <ul className="flex items-center gap-6 text-sm">
                ...
                <li><Link className="text-[#7A7580] transition hover:text-[#7A7580]/75" href="/terms">Terms</Link></li>
                <li><Link className="text-[#7A7580] transition hover:text-[#7A7580]/75" href="/privacy">Privacy</Link></li>
                <li><Link className="text-[#7A7580] transition hover:text-[#7A7580]/75" href="/quote">Quote</Link></li>
                <li><Link className="text-[#7A7580] transition hover:text-[#7A7580]/75" href="/enquiry">Enquiry</Link></li>
              </ul>
            </nav>
